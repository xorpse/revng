...
[the `revng-rs` README](https://github.com/xorpse/revng-rs) for the full discovery and linkage
contract.
...
```sh
cargo test -- --test-threads=1   # in a checkout of fugue-decompiler-revng
```
