...
See [the `revng-rs` README](https://github.com/xorpse/revng-rs) for the full discovery and
linkage contract.
...
is [`fugue-decompiler-revng`](https://github.com/fugue-re/fugue-decompiler-revng).
