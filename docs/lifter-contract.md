...
[`fugue-decompiler-revng`](https://github.com/fugue-re/fugue-decompiler-revng) shows the same embedding boundary
...
[`revng-sys`](https://github.com/xorpse/revng-rs) and
[`revng-build`](https://github.com/xorpse/revng-rs). Build scripts locate the staged SDK
